import {Body, Controller, Post, UseGuards, Request, Query, Res, HttpStatus} from '@nestjs/common';
...
export class AuthController {
    ...
    @Post('/signup')
    async signup(@Body() user: CreateUserDto, @Res({passthrough: true}) response) {
